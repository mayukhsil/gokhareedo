...
<div class="register-box" style="width: 360px; margin: auto;">
  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <form action="register_c.php" method="post">
        ...
        <div class="input-group mb-3">
          <input type="tel" minlength="10" name="cphone" class="form-control" placeholder="10-digit Phone Number (Do not include 0 or country code)" required="" maxlength="10">
          <div class="input-group-append">
            <div class="input-group-text">
