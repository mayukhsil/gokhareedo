...
$countph = mysqli_num_rows(mysqli_query($db,"select username from login_user where phone='$cphone'"));
...
{
	echo"<script>
		alert('Someone has already registered with this phone number. Use a different number');
		location.href='register.php'; 
					</script>";	
}
else
