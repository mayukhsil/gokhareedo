  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Pending Deliveries</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <?php
            $sid = $_SESSION['sid'];
              $sql="select o.*, c.cname, c.cphone from customer c, orders o where o.cid=c.cid and sid=$sid and status='Ready'";
            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td><?php echo date("H:i", strtotime($fetch['slot'])); ?></td>
                  <td>
